...
class ContentSeeder extends Seeder
{
    ...
    private function services(): void
    {
        Service::updateOrCreate(['slug' => 'weby-a-eshopy'], [
            ...
            'target_groups' => [
                'Potřebujete nový firemní web, který bude generovat poptávky, ne jen existovat.',
                'Máte zastaralý web nebo e-shop, který brzdí prodej a nejde rozumně rozvíjet.',
                'Chystáte kampaň a potřebujete landing page, která z návštěvy udělá objednávku.',
                'Chcete konečně vědět, co na webu funguje — a podle toho ho zlepšovat.',
            ],
    ...
    private function caseStudies(): void
    {
        ...
        CaseStudy::updateOrCreate(['slug' => 'rodinny-eshop'], [
            ...
            'headline_metric' => '+41 %',
            'tags' => [
                'Marketing: kampaně, měření',
                'Vývoj: šablony, integrace',
            ],
            ...
            'problem_points' => [
                'Pomalé načítání a zastaralé šablony produktů.',
                'Chybějící měření, žádná návaznost reklamy na tržby.',
                'Reklama vedla na produkty s nízkou marží.',
            ],
            ...
            'marketing_items' => [
                'Analýza ziskovosti podle produktů a přesun rozpočtu na to, co vydělává.',
                'Přestavba kampaní a práce se sdělením podle sezóny.',
                'Průběžné vyhodnocování a doporučení k nabídce.',
            ],
            'dev_title' => 'Role vývoje — Tom',
            'dev_items' => [
                'Přestavba klíčových šablon a zrychlení e-shopu na mobilu.',
                'Nastavení měření a propojení dat z reklamy s objednávkami.',
                'Automatizace opakovaných úprav feedu a reportů.',
            ],
            'results' => [
        ...
        CaseStudy::updateOrCreate(['slug' => 'web-generujici-poptavky'], [
            ...
            'headline_metric' => '3,2×',
            'tags' => [
                'Marketing: strategie, kampaně',
                'Vývoj: nový web, měření',
            ],
            ...
            'problem_points' => [
                'Nabídka nebyla srozumitelná pro nikoho zvenčí.',
                'Web neměl jediný jasný cíl ani cestu k poptávce.',
                'Žádná akvizice mimo doporučení.',
            ],
            'roles_title' => 'Jak jsme to táhli spolu',
            'roles_perex' => 'Marketing a vývoj neběžely po sobě, ale vedle sebe — jedno rozhodnutí ovlivnilo druhé.',
            'marketing_title' => 'Role marketingu — Pavel',
            'marketing_items' => [
                'Vyjasnění nabídky a sdělení pro konkrétní segment.',
                'Spuštění cílených kampaní na relevantní poptávky.',
                'Vyhodnocení kvality leadů, ne jen jejich počtu.',
            ],
            'dev_title' => 'Role vývoje — Tom',
            'dev_items' => [
                'Nový rychlý web s jasnou cestou k poptávkovému formuláři.',
                'Měření konverzí a napojení na reklamní systémy.',
                'Automatické notifikace poptávek do e-mailu.',
            ],
            'results' => [
        ...
        CaseStudy::updateOrCreate(['slug' => 'b2b-vyrobce-redesign'], [
            ...
            'problem_points' => [
                'Struktura odpovídala organigramu firmy, ne potřebám zákazníka.',
                'Nulová viditelnost v organickém vyhledávání.',
                'Žádné měření poptávek.',
            ],
            'roles_title' => 'Jak jsme to táhli spolu',
            'roles_perex' => 'Marketing a vývoj neběžely po sobě, ale vedle sebe — jedno rozhodnutí ovlivnilo druhé.',
            'marketing_title' => 'Role marketingu — Pavel',
            'marketing_items' => [
                'Analýza vyhledávání a přestavba struktury podle poptávky trhu.',
                'Přepis obsahu do jazyka zákazníka.',
                'Nastavení dlouhodobého obsahového plánu.',
            ],
            'dev_title' => 'Role vývoje — Tom',
            'dev_items' => [
                'Nový web s rychlým načtením a čistou technickou SEO základnou.',
                'Editovatelné produktové stránky bez nutnosti volat vývojáře.',
                'Měření poptávek a telefonátů.',
            ],
            'results' => [
        ...
        CaseStudy::updateOrCreate(['slug' => 'sezonni-landing-page'], [
            ...
            'headline_metric' => '−34 %',
            'tags' => [
                'Marketing: kampaň, sdělení',
                'Vývoj: landing page, měření',
            ],
            ...
            'problem_points' => [
                'Vstupní stránka bez jasného cíle.',
                'Rostoucí cena za rezervaci.',
                'Chybějící měření kroků rezervace.',
            ],
            'roles_title' => 'Jak jsme to táhli spolu',
            'roles_perex' => 'Marketing a vývoj neběžely po sobě, ale vedle sebe — jedno rozhodnutí ovlivnilo druhé.',
            'marketing_title' => 'Role marketingu — Pavel',
            'marketing_items' => [
                'Zúžení sdělení na jednu jedinou nabídku.',
                'Přestavba kampaně a cílení na sezónní poptávku.',
                'Průběžné testování variant sdělení.',
            ],
            'dev_title' => 'Role vývoje — Tom',
            'dev_items' => [
                'Rychlá landing page s jediným cílem — rezervací.',
                'Měření jednotlivých kroků a odpadů.',
                'Napojení rezervací na interní systém.',
            ],
            'results' => [
