...
HTML]]],
    ...
    /**
     * Dopadová stránka pro oslovování majitelů e-shopů. Chodí se na ni z e-mailu
     * nebo ze zprávy, ne z vyhledávání, takže vede rovnou k tomu, co nabízíme,
     * a končí výzvou poslat odkaz na e-shop.
     *
     * Sekce se v pořadí střídají světlá / tmavá, aby nikde nevznikly dva tmavé
     * pruhy za sebou. Když budete bloky přehazovat v administraci, držte se toho.
     *
     * Kde není nahraná fotka, drží místo šrafovaný zástupný vizuál s popiskem.
     * Ceny a metriky z odvedené práce tu schválně nejsou, doplňte je, až je
     * budete mít potvrzené od klientů.
     */
    private function eshopLandingPage(): void
    {
        Page::updateOrCreate(['slug' => 'e-shop'], [
