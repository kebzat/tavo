...
return [
    ...
    */
    ...
    |
    | POZOR: musí zůstat `public`. Filament předává tento disk do MediaLibrary
    | při nahrávání obrázků. Na disku `local` skončí soubory v
    | storage/app/private/, kam se z webu nedá dostat — obrázek se pak
    | v administraci tváří jako nahraný, ale na webu je rozbitý.
    |
    */
