...
<section class="section-x section-y overflow-hidden bg-ink text-cream">
    <div class="container-tavo">
        ...
        <div data-reveal class="grid grid-cols-1 gap-0.5 overflow-hidden rounded-[18px] bg-cream/15 loop:grid-cols-4 menu:grid-cols-2">
            @foreach ($items as $item)
                <div class="bg-ink px-[26px] py-[34px]">
