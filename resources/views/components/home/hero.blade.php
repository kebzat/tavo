...
<header id="top" class="section-x relative flex min-h-screen flex-col justify-center overflow-hidden pt-[150px] pb-[60px]">
    <div class="container-tavo relative z-2">
        <x-eyebrow data-reveal :rule="true" class="mb-[30px]">{{ $home->hero_eyebrow }}</x-eyebrow>

        <h1 class="text-hero m-0 max-w-[15ch] font-extrabold tracking-[-.03em]">
        ...
        <div class="mt-11 flex flex-wrap items-end gap-11">
            <p data-reveal class="text-perex m-0 max-w-[46ch] text-body">{{ $home->hero_perex }}</p>
