            ...
            <div class="container-tavo">
                ...
                <div>
                    @foreach ($others as $other)
                        <div data-svc class="grid grid-cols-[40px_1fr_auto] items-center gap-[26px] border-t border-ink/14 py-[clamp(28px,3.4vw,44px)] menu:grid-cols-[80px_1fr_auto] @if ($loop->last) border-b @endif">
                            ...
                            <div>
                                ...
                                <div class="mt-3.5 max-w-[60ch] text-[15px] leading-[1.5] text-muted">
                                    {{ $other->excerpt }}
                                    @if ($other->url())
                                        <a href="{{ $other->url() }}" class="font-bold whitespace-nowrap text-brick">Zjistit více →</a>
                                    @endif
                                </div>
                            </div>
